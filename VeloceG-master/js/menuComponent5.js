document.addEventListener("DOMContentLoaded", function () {
  function getContainerAndInsertDataIntoIt(containerId, data) {
    ...
    data.forEach(function (food) {
      ...
      foodElement +=
        '<img src="' + food.photo + '" class="img-responsive" alt="">';
      foodElement += "</div>";
  ...
  function getPastaData() {
    return [
      ...
      },
      {
        ...
        ingredients:
          "SOS ROȘII, SALVIA, CEAPsĂ, SPECK, PARMEZAN, VIN ALB - 450g",
        price: "26 RON",
        oldPrice: "24,99",
      },
      {
    ...
    return [
      {
        ...
        ingredients:
          "SALATĂ VERDE, RUCOLA,  ROȘII, CASTRAVEȚI, MORCOV, PORUMB, OU, TON, MĂSLINE, CEAPĂ, TELEMEA, CRUTOANE, ULEI DE MĂSLINE - 600g ",
        price: "25 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Veloce E Gusto",
        ingredients:
          "SALATĂ MIXTĂ, ROȘII, CASTRAVEȚI, PORUMB, PIEPT DE PUI, BRÂNZĂ FETA, CARTOFI PRĂJIȚI, ARDEI ROȘU, PARMEZAN, CRUTOANE, SOS ALB - 600g",
        price: "26 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Delicata",
        ingredients:
          "SALATĂ MIXTĂ. ROȘII, OREGANO, ȘUNCĂ, CASTRAVEȚI, MOZARELLA, ULEI DE MASLIE, APIO, CRUTOANE, ARDEI, PROSCIUTTO CRUDO, SOS ALB, LĂMÂIE - 500g",
        price: "25 RON",
        oldPrice: "24,99",
      },
      {
      ...
      },
      {
        ...
        name: "Salata Caesar",
        ingredients:
          "SALATĂ VERDE, CRUTOANE, PIEPT DE PUI, ROȘII, PARMEZAN, BRÂNZĂ TELEMEA, OREGANO, SOS ALB - 450g",
        price: "23 RON",
        oldPrice: "24,99",
      },
    ];
  ...
  function getPizzaData() {
    return [
      ...
      },
      {
        ...
        name: "Alta Vista",
        ingredients:
          "SOS ROȘII, MOZZARELA, PROSCIUTTO CRUDO ,  RUCOLLA, PARMEZAN,  GORGONZOLA - 530g",
        price: "24 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Delicata",
        ingredients:
          "SOS ROȘII, MOZZARELA, OREGANO, ROȘII CHERRY, RUCOLA, PARMEZAN, MOZZARELLA BOCCONCINI, ULEI MĂSLINE -660g",
        price: "26 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Bomba",
        ingredients:
          "SOS ROȘII, MOZZARELA, ȘUNCĂ, SALAM PICANT, PROSCIUTTO CRUDO, DOVLECEL, MĂSLINE, BUSUIOC - 670g",
        price: "28 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Capriciosa",
        ingredients:
          "SOS ROȘII, MOZARELLA, BACON, ClUPERCI, OU, PORUMB, MĂSLINE -730g ",
        price: "25 RON",
        oldPrice: "24,99",
      },
      {
      ...
      },
      {
        ...
        name: "Patatossa",
        ingredients:
          "SOS ROȘII, MOZARELLA, PIEP DE PUI, ULEI MĂSLINE CU AROMĂ DE USTUROI, CARTOFI PRĂJIȚI 560g",
        price: "27 RON",
        oldPrice: "24,99",
      },
      {
      ...
      },
      {
        ...
        name: "Maremonti",
        ingredients:
          "SOS ROȘII, MOZARELLA, FRUCTE DE MARE, CREVEȚI, ULEI DE MĂSLINE CU AROMA DE USTUROI - 650g",
        price: "29 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Veloce E Gusto",
        ingredients:
          "SOS ROȘII, MOZZARELLA, ȘUNCĂ, BACON, SALAM PICANT, CIUPERCI, PORUMB, PROSCIUTTO CRUDO, PARMEZAN -730g",
        price: "32 RON",
        oldPrice: "24,99",
      },
      {
      ...
      },
      {
        ...
        name: "Contadine",
        ingredients:
          "SOS ROȘII, MOZZARELLA, ȘUNCĂ, SPEK, ROȘII CHERRY, RUCOLA, PARMEZAN - 660g",
        price: "29 RON",
        oldPrice: "24,99",
      },
      {
        ...
        name: "Barone Roso",
        ingredients:
          "SOS ROȘII, MOZZARELLA, BACON, CIUPERCI, PEPERONCINO - 610g",
        price: "25 RON",
        oldPrice: "24,99",
      },
      {
      ...
      },
      {
        ...
        name: "Regina",
        ingredients:
          "SOS ROȘII, MOZZARELLA, PROSCIUTTO CRUDO, BOCONCINNI, ROȘII CHERRY, PARMEZAN - 720g",
        price: "28 RON",
        oldPrice: "24,99",
      },
      {
      ...
      },
      {
        ...
        name: "Pizza Gusto",
        ingredients:
          "SOS ROȘII, MOZZARELLA, ARDEI COPT, MĂSLINE, ROȘII USCATE, ANGHINARE, PORUMB, BUSUIOC, ClUPERCI - 790g",
        price: "27 RON",
        oldPrice: "24,99",
      },
      {
